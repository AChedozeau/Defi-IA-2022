...
# DATASET
            # Train
X_train_station = "./DATA_FULL/Train/Train/full_X_train.csv"
Y= "./DATA_FULL/Train/Train/full_Y_train.csv"
Y_train_station = pd.read_csv(Y,sep=",",header=0)
            # Test
path_baseline_test = './DATA_FULL/Test/Test/Baselines/'
X_station_test = "./DATA_FULL/Test/Test/full_X_test.csv"
